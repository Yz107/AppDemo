...
public final class CrashHandler {
    ...
    static {
        try {
            PackageInfo pi = MyApplication.getApplication()
                    .getPackageManager()
        ...
        UNCAUGHT_EXCEPTION_HANDLER = new UncaughtExceptionHandler() {
            ...
            public void uncaughtException(final Thread t, final Throwable e) {
                ...
                final String fullPath = (dir == null ? defaultDir : dir) + time + ".crash";
                if (createOrExistsFile(fullPath)) {
                    input2File(crashInfo, fullPath);
                } else {
                    Log.e("CrashHandler", "create " + fullPath + " failed!");
                }
    ...
    public static void init(final String crashDirPath, final OnCrashListener onCrashListener) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && MyApplication.getApplication().getExternalCacheDir() != null)
            defaultDir = MyApplication.getApplication().getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        else {
            defaultDir = MyApplication.getApplication().getCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }
    ...
    private static void input2File(final String input, final String filePath) {
        ...
        Log.e("CrashHandler", "write crash info to " + filePath + " failed!");
    }
